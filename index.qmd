...
```{python}
<<<<<<< Updated upstream
df = pd.read_csv("data/1.-mpceip_deeco_exportaciones_eeuu_2024_01csv", encoding="latin1")
=======
df = pd.read_csv("data/1.-mpceip_deeco_exportaciones_eeuu_2024_01csv", encoding="latin1")  # o utf-8
df.head()
>>>>>>> Stashed changes

# Generar dataset ficticio
X, y = df(n_samples=1000, n_features=5, 
...
```{python}
<<<<<<< Updated upstream
data = pd.read_csv("data/1.-mpceip_deeco_exportaciones_eeuu_2024_01csv", encoding="latin1")
=======
data = pd.read_csv("data/1.-mpceip_deeco_exportaciones_eeuu_2024_01csv", encoding="latin1") 
>>>>>>> Stashed changes
#data
